...
from .vgg16 import AdaIN_Encoder
...
class My_Adapter(nn.Module):
    ...
    # def forward(self, SR, HR, if_sample_style=False, style_mu=None, style_std=None):
    ...
    def forward(self, SR):
        ...
        print("SR:", SR.shape)
        # print("HR:", HR.shape)
        # x = self.merge_encoder(SR, HR, if_sample_style=if_sample_style, style_mu=style_mu, style_std=style_std)
