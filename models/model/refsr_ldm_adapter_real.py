...
class ControlledUnetModel(UNetModel):
    def forward(
        ...
        **kwargs,
        ...
        print("x ControlledUnetModel:", x.shape)
        print("control 0 ControlledUnetModel:", control[0].shape)
        print("control 1 ControlledUnetModel:", control[1].shape)
        print("control 2 ControlledUnetModel:", control[2].shape)
...
class ControlLDM(LatentDiffusion):
    ...
    def apply_cond_encoder(self, control_sr, control_style):
        # print("-------------control_style------------:", control_style.shape)
        if control_style is not None:
            control_style = control_style * 2 - 1
        # cond_latent = self.adapter(control_sr * 2 - 1, control_style, self.if_sample_style, self.style_mean, self.style_std)

        cond_latent = self.adapter(control_sr * 2 - 1)
    ...
    def get_input(self, batch, k, bs=None, *args, **kwargs):
        ...
        sr_cond_latent = self.apply_cond_encoder(sr_cond, style_cond)
    ...
    def apply_model(self, x_noisy, t, cond, *args, **kwargs):
        ...
        cond_control = cond["sr_cond_latent"][0]

        print("------- apply_model-----x_noisy----:", x_noisy.shape)
        print("------- apply_model-----cond_control----:", cond_control[0].shape)
    ...
    def sample_log(self, cond, steps):
        ...
        b, c, h, w = cond["sr_cond_latent"][0][0].shape
    ...
    def configure_optimizers(self):
        ...
        params = list(self.adapter.parameters()) + list(self.model.parameters())
